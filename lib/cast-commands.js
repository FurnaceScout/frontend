 ...
 * @returns {string} Cast command
 */
export function generateCastSend(
  contractAddress,
  functionSignature,
  args = [],
  options = {},
 ...
 * @returns {string} Cast command
 */
export function generateCastStorage(
  address,
  slot,
  rpcUrl = "http://127.0.0.1:8545",
) {
 ...
 * @returns {string} Cast command
 */
export function generateCastBlock(
  blockNumber,
  rpcUrl = "http://127.0.0.1:8545",
) {
 ...
 * @returns {string} Cast command
 */
export function generateCastEstimate(
  contractAddress,
  functionSignature,
  args = [],
  options = {},
 ...
 * @returns {string} Cast command
 */
export function generateCastToBase(value, _fromBase = "hex", toBase = "dec") {

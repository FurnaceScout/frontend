...
export default function CastCommandBuilder({
  ...
  useEffect(() => {
    if (_inputs && _inputs.length > 0) {
      setArgs(new Array(_inputs.length).fill(""));
    }
  }, [_inputs]);
